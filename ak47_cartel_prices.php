...
// Query to get both StatTrak and non-StatTrak variants of AK-47 | Cartel
$sql = "
    SELECT item_name, 
           COALESCE(MIN(lowest_sell_order), 'N/A') AS lowest_sell_order 
    FROM steam_output 
    WHERE LOWER(item_name) LIKE '%ak-47 | cartel%' 
    GROUP BY item_name 
...
<head>
    <meta charset="UTF-8">
    <title>AK-47 | Cartel Prices</title>
</head>
<body>
    <h1>AK-47 | Cartel Prices</h1>
    <table border="1">
        <tr>
            <th>Item Name</th>
