...
const res = knives.map((knife) => {
  const images = findImagesFor(knife.name);
  // Replace Factory New image with Minimal Wear image
  if (images['Minimal Wear'] && images['Factory New']) {
    images['Factory New'] = images['Minimal Wear'];
  }
  return {
    ...knife,
    image: images,
